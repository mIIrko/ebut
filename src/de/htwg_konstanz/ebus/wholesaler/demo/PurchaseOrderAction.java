		...
		if (loginBean != null && loginBean.isLoggedIn())
		{
			...
			if (Security.getInstance().isUserAllowed(loginBean.getUser(), Security.RESOURCE_ALL, Security.ACTION_READ))
			{
				...
				try
				{
					...
					{
						msg = "<p>Die Bestellung wurde zwar erfolgreich versendet, aber vom Lieferanten abgelehnt, weil mindestens eins der bestellten Produkte nicht (mehr) verf�gbar ist.<br>";
						msg += "OrderNumber: " + boOrderPurchase.getOrderNumber() + "<br>Supplier: " + boOrderPurchase.getSupplier().getCompanyname() + "</p>";
					}
					else
					{
						msg = "<p>Die Bestellung wurde erfolgreich versendet und vom Lieferanten best�tigt.<br>";
						msg += "OrderNumber: " + boOrderPurchase.getOrderNumber() + "<br>Supplier: " + boOrderPurchase.getSupplier().getCompanyname() + "</p>";
					}
